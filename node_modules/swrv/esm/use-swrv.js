...
// isRef,
getCurrentScope, onScopeDispose, isReadonly } from 'vue';
...
function resolveRetryFlag(_a) {
    var _b = _a.shouldRetry, shouldRetry = _b === void 0 ? undefined : _b, error = _a.error;
...
function useSWRV() {
    ...
    */
    ...
    var timer = null;
    if (!IS_SERVER) {
        var tick_1 = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
